...
parser.add_argument('-t', type=str, metavar='table_file', required=True, help='path to table file (from -VariantsToTable) containing just scaff, pos, and GT fields')
...
infofile=open(args.o+args.t+'INFO.txt','w')
