...
for j,pop in enumerate(pops):
    ...
    shfile.write('#!/bin/bash\n'+
                    ...
                    '/nbi/software/testing/ldr2/0.1/x86_64/LD_Chr '+args.i+pop+'.genotypes.txt '+args.i+pop+'.positions.txt ' + numind[j]+' '+numsites[j]+' '+args.mf+' '+args.maf+' '+outputdir+pop+' '+args.p+'\n')
    shfile.close()
